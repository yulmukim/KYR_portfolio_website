        ...
        <div className="skillspage">
            ...
            <div className="body">
                <h2 className="title">Skills</h2>
                    ...
                    <div className="html">
                        <img className="html_img" alt="html" src={html} width={50} height={50} />
                    ...
                    <div className="javascript">
                        <img className="javascript_img" alt="javascript" src={javascript} width={50} height={50} />
                    ...
                    <div className="css">
                        <img className="css_img" alt="css" src={css} width={50} height={50} />
                    ...
                    <div className="react">
                        <img className="react_img" alt="react" src={react} width={50} height={50} />
